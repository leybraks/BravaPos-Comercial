...
import { useErpDashboard } from './ERP/useErpDashboard'; // 👈 Importamos nuestro Hook

// ==========================================
// 📦 IMPORTACIÓN DE COMPONENTES MODULARIZADOS
// ==========================================
import Erp_DashboardVentas from './ERP/Erp_DashboardVentas';
import Erp_DashboardCartaQR from './ERP/Erp_DashboardCartaQR';
import Erp_EditorMenu from './ERP/Erp_EditorMenu';
import Erp_EditorPlanos from './ERP/Erp_EditorPlanos';
import Erp_Inventario from './ERP/Erp_Inventario';
import Erp_Personal from './ERP/Erp_Personal';
import Erp_Crm from './ERP/Erp_Crm';
import Erp_Configuracion from './ERP/Erp_Configuracion';

// 🧩 MODALES MODULARIZADOS
import Erp_ModalCambios from './ERP/Erp_ModalCambios';
import Erp_ModalCategorias from './ERP/Erp_ModalCategorias';
import Erp_ModalEmpleado from './ERP/Erp_ModalEmpleado';
import Erp_ModalPlato from './ERP/Erp_ModalPlato';
import Erp_ModalReceta from './ERP/Erp_ModalReceta';
import Erp_ModalVariaciones from './ERP/Erp_ModalVariaciones';
import Erp_Sidebar from './ERP/Erp_Sidebar';
